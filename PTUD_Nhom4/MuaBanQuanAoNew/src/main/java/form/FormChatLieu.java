 ...
 * @author Hoàng Huy
 */
public class FormChatLieu extends javax.swing.JPanel  implements ActionListener, MouseListener{
    ...
    private void initComponents() {
        ...
        jLabel16.setText("THÔNG TIN CHẤT LIỆU");

        jPanel1.setBackground(new java.awt.Color(204, 204, 255));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 153, 153), null), "Chất Liệu", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 18))); // NOI18N

        txtTen.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtTen.setHintText("Vải");

        jLabel11.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel11.setText("Tên Chất Liêu:");
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (r >= 0) {
            ...
            ChatLieu ncc = new ChatLieu(ma, ten);
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if (r >= 0) {
            ...
            int click = JOptionPane.showConfirmDialog(null, "Bạn có chắc xóa chất liệu  ", "Thông Báo", 2);
            if (click == JOptionPane.OK_OPTION) {
                // else ) {
                if (cl_dao.xoa(maNCC)) {
                    JOptionPane.showMessageDialog(null, "Xóa chất liệu thành công");
                }
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        ChatLieu ncc = reverSPFromTextFile();
    ...
    private void btnTimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimActionPerformed
        xoaModel(table);
        ArrayList<ChatLieu> LisTimNCC = new ArrayList<ChatLieu>();
        LisTimNCC = cl_dao.traCuuCL(txtTim.getText().toString().trim());
        if (LisTimNCC.size() > 0) {
            for (ChatLieu cv : LisTimNCC) {
                dataModel.addRow(new Object[] { cv.getMaCL(), cv.getTenCL()});
            }
        } else {
    ...
    private void updateTable() {
        ...
        ArrayList<ChatLieu> ListNCC = cl_dao.getAllCL();
        for (ChatLieu ncc : ListNCC) {
            dataModel.addRow(
                    new Object[]{ncc.getMaCL(), ncc.getTenCL()});
        }
    }
	...
	private ChatLieu reverSPFromTextFile() {
		String ten = txtTen.getText().toString();
