 ...
 * @author Hoàng Huy
 */
public class FormDanhMuc extends javax.swing.JPanel implements ActionListener, MouseListener {
    ...
    private void initComponents() {
        ...
        jLabel16.setText("THÔNG TIN DANH MỤC");

        jPanel1.setBackground(new java.awt.Color(204, 204, 255));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 153, 153), null), "Danh Mục", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 18))); // NOI18N

        txtTen.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtTen.setHintText("Áo");
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (r >= 0) {
            ...
            DanhMucSP ncc = new DanhMucSP(ma, ten);
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        if (r >= 0) {
            ...
            int click = JOptionPane.showConfirmDialog(null, "Bạn có chắc xóa Danh Mục  ", "Thông Báo", 2);
            if (click == JOptionPane.OK_OPTION) {
                // else ) {
                if (dm_dao.xoa(maNCC)) {
    ...
    private void btnTimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimActionPerformed
        xoaModel(table);
        ArrayList<DanhMucSP> LisTimNCC = new ArrayList<DanhMucSP>();
        LisTimNCC = dm_dao.traCuuDM(txtTim.getText().toString().trim());
        if (LisTimNCC.size() > 0) {
            for (DanhMucSP cv : LisTimNCC) {
                dataModel.addRow(new Object[] { cv.getMaDanhMuc(), cv.getTenDanhMuc()});
            }
        } else {
            JOptionPane.showMessageDialog(null, "Không Có Danh Mục Nào Phù Hợp");
            xoaModel(table);
            updateTable();
        }
    ...
    private void updateTable() {
        ...
        ArrayList<DanhMucSP> ListNCC = dm_dao.getAllDM();
        for (DanhMucSP ncc : ListNCC) {
            dataModel.addRow(
                    new Object[]{ncc.getMaDanhMuc(), ncc.getTenDanhMuc()});
        }
    }
	...
	private DanhMucSP reverSPFromTextFile() {
		String ten = txtTen.getText().toString();

		return new DanhMucSP(ten);
	}
