 ...
 * @author Hoàng Huy
 */
public class FormNhaSX extends javax.swing.JPanel implements ActionListener, MouseListener {

    /**
     * Creates new form FormNhaSX
     */
    public FormNhaSX() {
    	try {
        ...
        sx_dao = new NhaSX_Dao();
        updateTable();
    }
    private NhaSX_Dao sx_dao;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(0, 153, 153), null), "Nhà Sản Xuât", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 18))); // NOI18N

        txtTen.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtTen.setHintText("Duy Huy");
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
		...
		if (r >= 0) {
			...
			int click = JOptionPane.showConfirmDialog(null, "Bạn có chắc xóa nhà sản xuất  ", "Thông Báo", 2);
			if (click == JOptionPane.OK_OPTION) {
				// else ) {
				if (sx_dao.xoa(maNCC)) {
					JOptionPane.showMessageDialog(null, "Xóa sản xuất thành công");
				}
    ...
    private void btnTimActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimActionPerformed
    	xoaModel(table);
		ArrayList<NhaSX> LisTimNCC = new ArrayList<NhaSX>();
		LisTimNCC = sx_dao.traCuuNSX(txtTim.getText().toString().trim());
		if (LisTimNCC.size() > 0) {
			for (NhaSX cv : LisTimNCC) {
				dataModel.addRow(new Object[] { cv.getMaNSX(), cv.getTenNSX()});
			}
		} else {
    ...
    private void updateTable() {
        ...
        ArrayList<NhaSX> ListNCC = sx_dao.getAllNSX();
        for (NhaSX ncc : ListNCC) {
            dataModel.addRow(
                    new Object[]{ncc.getMaNSX(), ncc.getTenNSX()});
        }
    }
	...
	private NhaSX reverSPFromTextFile() {
		String ten = txtTen.getText().toString();

		return new NhaSX(ten);
	}
